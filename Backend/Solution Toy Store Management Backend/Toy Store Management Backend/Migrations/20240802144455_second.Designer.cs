...
namespace Toy_Store_Management_Backend.Migrations
{
    ...
    [Migration("20240802144455_second")]
            ...
            modelBuilder.Entity("Toy_Store_Management_Backend.Models.Toy", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 6,
                            AgeRange = "7-9years",
                            ArrivalDate = new DateTime(2024, 8, 2, 20, 14, 54, 430, DateTimeKind.Local).AddTicks(7480),
                            BrandId = 2,
                            CategoryId = 2,
                        ...
                        new
                        {
                            Id = 7,
                            AgeRange = "3-5years",
                            ArrivalDate = new DateTime(2024, 8, 2, 20, 14, 54, 430, DateTimeKind.Local).AddTicks(7499),
                            BrandId = 5,
                            CategoryId = 3,
                        ...
                        new
                        {
                            Id = 8,
                            AgeRange = "5-7years",
                            ArrivalDate = new DateTime(2024, 8, 2, 20, 14, 54, 430, DateTimeKind.Local).AddTicks(7501),
                            BrandId = 2,
                            CategoryId = 2,
                        ...
                        new
                        {
                            Id = 9,
                            AgeRange = "12-14years",
                            ArrivalDate = new DateTime(2024, 8, 2, 20, 14, 54, 430, DateTimeKind.Local).AddTicks(7503),
                            BrandId = 3,
                            CategoryId = 4,
                        ...
                        new
                        {
                            Id = 10,
                            AgeRange = "8-10years",
                            ArrivalDate = new DateTime(2024, 8, 2, 20, 14, 54, 430, DateTimeKind.Local).AddTicks(7505),
                            BrandId = 5,
                            CategoryId = 2,
